...
for data in args.data.split('-'):
    ...
    if noise == 'gaussian':
        if data == 'train':
            ...
            os.system(f'gdrive files download {WaterlooED} --destination Datasets/Downloads/')
            ...
            os.system(f'gdrive files download {DIV2K} --destination Datasets/Downloads/')
            ...
            os.system(f'gdrive files download {BSD400} --destination Datasets/Downloads/')
            ...
            os.system(f'gdrive files download {Flickr2K} --destination Datasets/Downloads/')
        ...
        if data == 'test':
            ...
            os.system(f'gdrive files download {gaussian_test} --destination Datasets/')
